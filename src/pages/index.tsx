...
function CreateRoomModalBody({}) {
  ...
  const createRoom = () => {
    ...
    trpc.useQuery(
      ...
      {
        onSuccess: (data: { createdRoom: ChatRoom }) => {
          console.log(data);
          setCurrentRoom(data.createdRoom);
        },
      }
    );
  };
...
const ButtonGroup = ({ activeChannels, username, setUsername }) => {
    ...
    <>
      ...
      <div className="flex">
        <div className="flex">
          ...
          <div className="flex">
            <div className="btn m-2 modal-button" onClick={() => openModal()}>
